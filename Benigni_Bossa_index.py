...
def f_SA18(mol, includeSpiro=False):
    ...
    highlightBonds = np.array([])
    list_hit_atss = np.array([])
    ri = mol.GetRingInfo()
    systems = []
                ...
                if len(ringsist)>11:
                    ...
                    if set(carbon_atoms) == {6}:
                        ...
                        for bond in mol.GetBonds():
                            ...
                            hit_bonds = []
                            if End in ringsist and Begin in ringsist:
                                hit_bonds.append(mol.GetBondBetweenAtoms(Begin,End).GetIdx())

                        hit_bondss.append(hit_bonds)
                        hit_atss.append(list(ringsist))
...
def f_SA30(molecule: Chem.rdchem.Mol):
    ...
    substructure2 = "O=C1C=Cc2ccccc2O1"
    substructure2 = Chem.MolFromSmarts(substructure2)
    sub = [substructure, substructure2]
...
def all_index_atoms(molecule: Chem.rdchem.Mol):
    ...
    idx = [ np.array(f_SA1(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA2(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA3(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA4(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA5(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA6(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA7(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA8(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA9(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA10(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA11(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA12(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA13(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA14(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA15(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA16(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA17(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA18(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA19(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA21(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA22(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA23(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA24(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA25(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA26(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA27(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA28(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA28bis(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA28ter(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA29(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA30(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA31a(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA31b(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA31c(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA37(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA38(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA39(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA40(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA41(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA42(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA43(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA44(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA45(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA46(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA47(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA48(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA49(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA50(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA51(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA52(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA53(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA55(molecule)[1]).reshape(1,-1).tolist()[0]+
            np.array(f_SA56(molecule)[1]).reshape(1,-1).tolist()[0]]
...
def all_index_bonds(molecule: Chem.rdchem.Mol):
    ...
    idx = [ np.array(f_SA1(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA2(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA3(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA4(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA5(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA6(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA7(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA8(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA9(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA10(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA11(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA12(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA13(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA14(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA15(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA16(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA17(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA18(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA19(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA21(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA22(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA23(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA24(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA25(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA26(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA27(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA28(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA28bis(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA28ter(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA29(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA30(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA31a(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA31b(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA31c(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA37(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA38(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA39(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA40(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA41(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA42(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA43(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA44(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA45(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA46(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA47(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA48(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA49(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA50(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA51(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA52(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA53(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA55(molecule)[0]).reshape(1,-1).tolist()[0]+
            np.array(f_SA56(molecule)[0]).reshape(1,-1).tolist()[0]]
